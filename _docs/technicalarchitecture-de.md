...
{% include image.html src="docs/about/libraries_used.webp" alt="mainy open source libraries are used" %}
...
{% include image.html src="docs/about/server_client_architecture.webp" alt="Common server Server-Client Architecture" %}
